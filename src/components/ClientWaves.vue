<template>
    <div class="after:absolute after:h-[100vh] after:w-[100vw] after:bg-white dark:after:bg-base-100 after:text-white/0 after:content-['']" :class="cssOpacityValue">
...
const cssOpacityValue = computed(() => {
    ...
    switch (props.opacity) {
        case '10':
            return props.color === 'white' ? 'after:bg-white/10 dark:after:bg-base-100/10' : 'after:bg-blue-500/10 dark:after:bg-blue-500/10'
        case '30':
            return props.color === 'white' ? 'after:bg-white/30 dark:after:bg-base-100/30' : 'after:bg-blue-500/30 dark:after:bg-blue-500/30'
        case '50':
            return props.color === 'white' ? 'after:bg-white/50 dark:after:bg-base-100/50' : 'after:bg-blue-500/50 dark:after:bg-blue-500/50'
        case '70':
            return props.color === 'white' ? 'after:bg-white/70 dark:after:bg-base-100/70' : 'after:bg-blue-500/70 dark:after:bg-blue-500/70'
        case '90':
            return props.color === 'white' ? 'after:bg-white/90 dark:after:bg-base-100/90' : 'after:bg-blue-500/90 dark:after:bg-blue-500/90'
        default:
            return ''
    }
})
